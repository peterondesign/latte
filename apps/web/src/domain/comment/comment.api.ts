...
export class CommentApi {
  ...
  static findOne(
    ...
    return HttpService.api.get(
      `/v1/comments/${commentId}${buildOptions}`,
    )
  }
...
static findManyByUserId(
  ...
  static createOneByUserId(
    ...
    return HttpService.api.post(
      `/v1/users/user/${userId}/comments`,
      values,
    )
  }
  
  static findManyByProfileUserId(
    ...
    return HttpService.api.get(
      `/v1/users/profileUser/${profileUserId}/comments${buildOptions}`,
    )
  }

  static createOneByProfileUserId(
    profileUserId: string,
    values: Partial<Comment>,
  ): Promise<Comment> {
    return HttpService.api.post(
      `/v1/users/profileUser/${profileUserId}/comments`,
      values,
    )
  }
