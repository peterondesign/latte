...
@Get('/user/:userId/comments')
  async findManyUserId(
    ...
    const items =
      await this.commentDomainFacade.findManyByUser(
        parent,
        queryOptions,
      )
  ...
  @Get('/profileUser/:profileUserId/comments')
  async findManyProfileUserId(
    ...
    const items =
      await this.commentDomainFacade.findManyByProfileUser(
        parent,
        queryOptions,
      )
  ...
  @Post('/profileUser/:profileUserId/comments')
  async createByProfileUserId(
    @Param('profileUserId') profileUserId: string,
    @Body() body: CommentCreateDto,
    @Req() request: Request,
  ) {
    ...
    const valuesUpdated = { ...body, profileUserId }
